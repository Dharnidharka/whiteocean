 ...
 */
        ...
        $header_logo_title = array(
                        'one' => __('Default', 'options_check'),
                        'two' => __('Logo', 'options_check'),
                        'three' => __('Title', 'options_check')
                );
                
             
             $skill_title = array(
                        '1' => __('1 Line', 'options_check'),
                        '2' => __('2 Line', 'options_check'),
                        '3' => __('3 Line', 'options_check'),
                        '4' => __('4 Line', 'options_check'),
                        '5' => __('5 Line', 'options_check'),
                        '6' => __('6 Line', 'options_check'),
                        '7' => __('7 Line', 'options_check'),
                        '8' => __('8 Line', 'options_check'),
                        '9' => __('9 Line', 'options_check'),
                       '10' => __('10 Line', 'options_check')
                );
            ...
            for( $i=1; $i<=5; $i++) {
                $options[] = array(
                    'name' 	=>	sprintf( __( 'Slider #%1$s', 'sksdev' ), $i ),
                    'desc' 	=> __( 'Upload slider image.', 'sksdev' ),
                    'id' 		=> 'sksdev_slider_image'.$i,
					'std' => __( ''.get_template_directory_uri() . '/images/slide'.$i.'.jpg', 'sksdev' ),
                    'type' 	=> 'upload'
                );
                $options[] = array(
