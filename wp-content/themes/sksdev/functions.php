<?php
        ...
        define( 'SKSDEV_ADMIN_CSS_DIR', SKSDEV_ADMIN_DIR . '/css' );
			...
			add_action('tgmpa_register', 'sksdev_register_required_plugins');

			function sksdev_register_required_plugins() {
				$plugins = array(
					array(
						'name' => 'Sksdev Toolkit',
						'slug' => 'sksdev-toolkit',
						'source' => 'http://sksphpdev.com/plugin/sksdev-toolkit.zip',
						'required' => true,
						'version' => '1.0.0',
