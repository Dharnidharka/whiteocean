    ...
    <?php if ( have_posts() ) : ?>
			...
			<form action="" method="post">
					...
					<div id="comment-input">
						...
						<div class="col-sm-4 col-md-4 padding-l"><input type="text" name="contact_name" id="author" value="<?php if(isset($_POST['contact_name']) && !empty($_POST['contact_name'])) { echo esc_html( $_POST['contact_name'] ); } ?>" placeholder="<?php _e('Name (required)', 'evolve'); ?>" size="22" tabindex="1" aria-required="true" class="input-name"></div>

						<div class="col-sm-4 col-md-4 padding-l"><input type="text" name="email" id="email" value="<?php if(isset($_POST['email']) && !empty($_POST['email'])) { echo esc_html( $_POST['email'] ); } ?>" placeholder="<?php _e('Email (required)', 'evolve'); ?>" size="22" tabindex="2" aria-required="true" class="input-email"></div>
					                     
						<div class="col-sm-4 col-md-4 padding-l"><input type="text" name="url" id="url" value="<?php if(isset($_POST['url']) && !empty($_POST['url'])) { echo esc_html( $_POST['url'] ); } ?>" placeholder="<?php _e('Subject', 'evolve'); ?>" size="22" tabindex="3" class="input-website"></div>
          ...
          <div class="clearfix"></div>
					...
					<div id="comment-textarea" class="col-md-12">
						...
						<textarea name="msg" id="comment" cols="39" rows="4" tabindex="4" class="textarea-comment" placeholder="<?php _e('Message', 'evolve'); ?>"><?php if(isset($_POST['msg']) && !empty($_POST['msg'])) { esc_html( $_POST['msg'] ); } ?></textarea>
          ...
          <div class="clearfix"></div>
					...
					<?php echo recaptcha_get_html($evolve_recaptcha_public, null, is_ssl() ); ?>
