...
$options[] = array( "name" => __( 'Required Captcha Plugin', 'evolve' ),
"desc" => __( 'Please install', 'evolve' ). " <a href='http://wordpress.org/plugins/wp-recaptcha/'>WP-reCAPTCHA</a> ". __(' plugin to enable spam protection on the contact page.', 'evolve' ),
"id" => $evolve_shortname."_captcha_plugin",
"std" => 0,
"type" => "info");
}

$options[] = array( "name" => __( 'Recaptcha Public Key', 'evolve' ),
"desc" => __( 'Follow the steps in our docs to get your key', 'evolve' ),
"id" => $evolve_shortname."_recaptcha_public",
"std" => "",
"type" => "text");

$options[] = array( "name" => __( 'Recaptcha Private Key', 'evolve' ),
"desc" => __( 'Follow the steps in our docs to get your key', 'evolve' ),
